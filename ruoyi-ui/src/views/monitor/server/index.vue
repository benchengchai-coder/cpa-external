            ...
            <table cellspacing="0" style="width: 100%;">
              ...
              <tbody v-if="server.disks">
                <tr v-for="(disk, index) in server.disks" :key="index">
                  <td class="el-table__cell is-leaf"><div class="cell">{{ disk.dirName }}</div></td>
                  <td class="el-table__cell is-leaf"><div class="cell">{{ disk.sysTypeName }}</div></td>
                  <td class="el-table__cell is-leaf"><div class="cell">{{ disk.typeName }}</div></td>
                  <td class="el-table__cell is-leaf"><div class="cell">{{ disk.total }}</div></td>
                  <td class="el-table__cell is-leaf"><div class="cell">{{ disk.free }}</div></td>
                  <td class="el-table__cell is-leaf"><div class="cell">{{ disk.used }}</div></td>
                  <td class="el-table__cell is-leaf"><div class="cell" :class="{'text-danger': disk.usage > 80}">{{ disk.usage }}%</div></td>
                </tr>
              </tbody>
            </table>
          </div>
