...
// 更新用户计费倍率
export function updateUserBillingMultiplier(userId: number, billingMultiplier: number): Promise<AjaxResult> {
  return request({
    url: '/system/user/billingMultiplier',
    method: 'put',
    data: { userId, billingMultiplier }
  })
}
