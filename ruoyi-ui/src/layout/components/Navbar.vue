      ...
      <el-dropdown @command="handleCommand" class="avatar-container right-menu-item hover-effect" trigger="hover">
        ...
        <template #dropdown>
          <el-dropdown-menu>
            ...
            <el-dropdown-item v-if="canShowLayoutSettings" command="setLayout">
              <span>布局设置</span>
            </el-dropdown-item>
...
const canShowLayoutSettings = computed(() => settingsStore.showSettings)
...
function handleCommand(command: string): void {
  switch (command) {
    case 'setLayout':
      if (canShowLayoutSettings.value) {
        setLayout()
      }
      break
    case 'lockScreen':
