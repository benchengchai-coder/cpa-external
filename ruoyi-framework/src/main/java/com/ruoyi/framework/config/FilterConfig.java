...
public class FilterConfig
{
    ...
    /**
     * 禁止 JwtAuthenticationTokenFilter 被 @Component 自动注册为 Servlet Filter。
     * 它只应通过 SecurityConfig 的 SecurityFilterChain 运行。
     */
    @Bean
    public FilterRegistrationBean<JwtAuthenticationTokenFilter> jwtAuthenticationTokenFilterRegistration(JwtAuthenticationTokenFilter filter)
    {
