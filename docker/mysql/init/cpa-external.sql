/*
 ...
 Source Schema         : cpa_external

 Target Server Type    : MySQL
 Target Server Version : 80405 (8.4.5)
 File Encoding         : 65001

 Date: 23/07/2026 13:50:01
*/
...
CREATE TABLE `ai_apikey`  (
  ...
  `status` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '0' COMMENT '状态（0正常 1停用 2已耗尽 3已过期）',
  `group_mode` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'fixed' COMMENT '分组模式（fixed=固定分组 auto=自动轮询）',
  `group_id` bigint NULL DEFAULT NULL COMMENT '指定分组ID（group_mode=fixed时必填，auto时为空）',
  `model_limits_enabled` tinyint NOT NULL DEFAULT 0 COMMENT '是否启用模型限制（0否 1是）',
  `limit_models` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '模型限制列表（逗号分隔模型名称，仅 model_limits_enabled=1 时生效）',
  `cross_group_retry` tinyint NOT NULL DEFAULT 0 COMMENT '跨分组重试（0否 1是，仅group_mode=auto时有效）',
  `remain_balance` decimal(18, 10) NOT NULL DEFAULT 0.0000000000 COMMENT '剩余额度（美元）',
  `unlimited_balance` tinyint NOT NULL DEFAULT 0 COMMENT '无限额度（0否 1是）',
  `used_balance` decimal(18, 10) NOT NULL DEFAULT 0.0000000000 COMMENT '已用金额（美元）',
  `frozen_balance` decimal(18, 10) NOT NULL DEFAULT 0.0000000000 COMMENT '冻结额度（美元）',
  `expired_time` datetime NULL DEFAULT NULL COMMENT '过期时间（NULL=永不过期）',
  `allow_ips` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT 'IP白名单（逗号分隔）',
...
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'AI API Key表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 593 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'AI幂等结算记录' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ai_billing_settlement_task`  (
  ...
  `user_id` bigint NOT NULL COMMENT '用户ID',
  `key_id` bigint NULL DEFAULT NULL COMMENT 'API Key ID',
  `actual_cost` decimal(18, 10) NOT NULL COMMENT '应计金额投递快照（以ai_billing_record.amount为权威）',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'AI计费异步结算任务' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 24 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '每日签到记录表' ROW_FORMAT = DYNAMIC;
...
-- ----------------------------
-- Records of ai_invite_affiliate
-- ----------------------------
INSERT INTO `ai_invite_affiliate` VALUES (1, 'CZQN4BNFHLJF', NULL, 2, 0.0000000000, 0.0000000000, 15.0000000000, NULL, '', '2026-06-29 00:57:41', '', '2026-07-05 19:02:02', NULL);
INSERT INTO `ai_invite_affiliate` VALUES (103, 'JC9SXR84E5QQ', NULL, 0, 0.0000000000, 0.0000000000, 0.0000000000, NULL, '', '2026-06-29 15:32:46', '', NULL, NULL);
INSERT INTO `ai_invite_affiliate` VALUES (104, 'BRXCQHRLLMCJ', NULL, 0, 0.0000000000, 0.0000000000, 0.0000000000, NULL, '', '2026-07-02 10:45:20', '', NULL, NULL);
INSERT INTO `ai_invite_affiliate` VALUES (105, 'ZCEGP4KVBAH6', 1, 0, 0.0000000000, 0.0000000000, 0.0000000000, NULL, '', '2026-07-05 17:32:08', '', '2026-07-05 17:32:08', NULL);
INSERT INTO `ai_invite_affiliate` VALUES (106, '7S33J4G376DC', 1, 0, 0.0000000000, 0.0000000000, 0.0000000000, NULL, '', '2026-07-05 19:00:26', '', '2026-07-05 19:00:26', NULL);
INSERT INTO `ai_invite_affiliate` VALUES (107, '84M52NAGNPJK', NULL, 0, 0.0000000000, 0.0000000000, 0.0000000000, NULL, '', '2026-07-20 11:17:39', '', NULL, NULL);
...
-- ----------------------------
-- Records of ai_invite_rebate_record
-- ----------------------------
INSERT INTO `ai_invite_rebate_record` VALUES (1, 1, 105, '1', 10.0000000000, '2', 24, NULL, NULL, '', '2026-07-05 17:35:13', '', NULL, NULL);
INSERT INTO `ai_invite_rebate_record` VALUES (2, 1, NULL, '2', 10.0000000000, NULL, NULL, 236.1758000000, NULL, '', '2026-07-05 17:37:26', '', NULL, NULL);
INSERT INTO `ai_invite_rebate_record` VALUES (3, 1, 106, '1', 5.0000000000, '2', 26, NULL, NULL, '', '2026-07-05 19:01:31', '', NULL, NULL);
INSERT INTO `ai_invite_rebate_record` VALUES (4, 1, NULL, '2', 5.0000000000, NULL, NULL, 241.1758000000, NULL, '', '2026-07-05 19:02:02', '', NULL, NULL);
...
INSERT INTO `ai_dashboard_daily_state` VALUES (1, 0, NULL, NULL, NULL, CURRENT_TIMESTAMP(3), CURRENT_TIMESTAMP(3));
...
-- ----------------------------
DROP TABLE IF EXISTS `ai_model_usage_daily`;
...
) ENGINE = InnoDB AUTO_INCREMENT = 113 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'AI模型表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ai_model
-- ----------------------------
INSERT INTO `ai_model` VALUES (100, 'gpt-5.5', NULL, '', 'openai', 5.000000, 30.000000, 0.500000, NULL, '0', 'admin', '2026-06-01 21:21:21', 'admin', '2026-06-01 21:24:08', NULL);
INSERT INTO `ai_model` VALUES (101, 'gpt-5.4', NULL, '', 'openai', 2.500000, 15.000000, 0.250000, NULL, '0', 'admin', '2026-06-01 22:43:24', 'admin', '2026-06-04 15:13:27', NULL);
INSERT INTO `ai_model` VALUES (105, 'gpt-5.4-mini', NULL, '', 'openai', 0.750000, 4.500000, 0.080000, NULL, '0', 'admin', '2026-06-04 14:48:15', 'admin', '2026-06-04 15:14:15', NULL);
INSERT INTO `ai_model` VALUES (109, 'glm-5.2', NULL, '', 'zhipu', 8.000000, 28.000000, 2.000000, NULL, '0', 'admin', '2026-06-26 20:21:30', 'admin', '2026-06-26 22:21:11', NULL);
...
INSERT INTO `ai_model` VALUES (112, 'gpt-5.6-luna', NULL, '', 'openai', 1.000000, 6.000000, 0.100000, 1.250000, '0', 'admin', '2026-07-09 23:09:31', 'admin', '2026-07-10 09:41:57', NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 93 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'OAuth认证审计日志表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 50 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '支付宝支付订单表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 107 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'AI平台表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ai_platform
-- ----------------------------
INSERT INTO `ai_platform` VALUES (100, 'openai', 'OpenAI', '0', NULL);
INSERT INTO `ai_platform` VALUES (103, 'zhipu', '智谱', '0', NULL);
...
CREATE TABLE `ai_recharge_record`  (
  ...
  INDEX `idx_user_id`(`user_id` ASC) USING BTREE,
  INDEX `idx_create_time`(`create_time` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 56 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'AI充值记录表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'AI订阅套餐' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ai_subscription_plan
-- ----------------------------
INSERT INTO `ai_subscription_plan` VALUES (1, '基础套餐A', '可用额度450刀', 79.0000000000, 'month', 1, NULL, 89.0000000000, 'none', NULL, '0', 0, NULL, 1, 'admin', '2026-06-07 02:03:14', 'admin', '2026-06-23 13:50:27', '');
INSERT INTO `ai_subscription_plan` VALUES (4, '高级套餐B', '可用额度1000刀', 169.0000000000, 'month', 1, NULL, 200.0000000000, 'none', NULL, '0', 4, NULL, 1, 'admin', '2026-06-07 02:04:28', 'admin', '2026-06-23 16:21:14', '');
...
) ENGINE = InnoDB AUTO_INCREMENT = 21 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'AI订阅流水' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ai_subscription_record
-- ----------------------------
INSERT INTO `ai_subscription_record` VALUES (1, 1, 'admin', 4, '高级套餐D', 1, 'purchase', 199.0000000000, '余额购买', 'admin', '0', 'admin', '2026-06-07 02:08:17', '', NULL, '余额购买订阅');
INSERT INTO `ai_subscription_record` VALUES (2, 1, 'admin', 1, '基础套餐A', 2, 'purchase', 69.0000000000, '余额购买', 'admin', '0', 'admin', '2026-06-07 02:12:05', '', NULL, '余额购买订阅');
INSERT INTO `ai_subscription_record` VALUES (3, 100, 'a15902193', 1, '基础套餐A', 3, 'grant', 0.0000000000, '后台授予', 'admin', '0', 'admin', '2026-06-10 10:01:47', '', NULL, '');
INSERT INTO `ai_subscription_record` VALUES (4, 1, 'admin', 1, '基础套餐A', 2, 'replace', 0.0000000000, '订阅替换', 'admin', '0', 'admin', '2026-06-10 10:32:14', '', NULL, '因授予新订阅而自动取消');
INSERT INTO `ai_subscription_record` VALUES (5, 1, 'admin', 1, '基础套餐A', 4, 'grant', 0.0000000000, '后台授予', 'admin', '0', 'admin', '2026-06-10 10:32:14', '', NULL, '');
INSERT INTO `ai_subscription_record` VALUES (6, 1, 'admin', 1, '基础套餐A', 4, 'replace', 0.0000000000, '订阅替换', 'admin', '0', 'admin', '2026-06-10 10:32:42', '', NULL, '因授予新订阅而自动取消');
INSERT INTO `ai_subscription_record` VALUES (7, 1, 'admin', 1, '基础套餐A', 5, 'grant', 0.0000000000, '后台授予', 'admin', '0', 'admin', '2026-06-10 10:32:42', '', NULL, '');
INSERT INTO `ai_subscription_record` VALUES (8, 101, 'b15902193', 4, '高级套餐D', 6, 'grant', 0.0000000000, '后台授予', 'admin', '0', 'admin', '2026-06-11 02:12:39', '', NULL, '');
INSERT INTO `ai_subscription_record` VALUES (9, 101, 'b15902193', 4, '高级套餐D', 6, 'expire', 0.0000000000, '系统过期', 'system', '0', 'system', '2026-06-11 09:42:52', '', NULL, '订阅已过期');
INSERT INTO `ai_subscription_record` VALUES (10, 104, 'a15902193', 1, '基础套餐A', 7, 'grant', 0.0000000000, '后台授予', 'admin', '0', 'admin', '2026-07-05 14:51:11', '', NULL, '');
INSERT INTO `ai_subscription_record` VALUES (11, 1, 'admin', 1, '基础套餐A', 5, 'expire', 0.0000000000, '系统过期', 'system', '0', 'system', '2026-07-10 10:44:55', '', NULL, '订阅已过期');
INSERT INTO `ai_subscription_record` VALUES (12, 100, 'a15902193', 1, '基础套餐A', 3, 'expire', 0.0000000000, '系统过期', 'system', '0', 'system', '2026-07-12 21:26:05', '', NULL, '订阅已过期');
INSERT INTO `ai_subscription_record` VALUES (13, 1, 'admin', 1, '基础套餐A', 8, 'purchase', 79.0000000000, '余额购买', 'admin', '0', 'admin', '2026-07-12 22:30:55', '', NULL, '余额购买订阅');
INSERT INTO `ai_subscription_record` VALUES (14, 1, 'admin', 1, '基础套餐A', 8, 'cancel', 0.0000000000, '后台取消', 'admin', '0', 'admin', '2026-07-12 22:34:11', '', NULL, '取消订阅');
INSERT INTO `ai_subscription_record` VALUES (15, 1, 'admin', 1, '基础套餐A', 9, 'purchase', 79.0000000000, '余额购买', 'admin', '0', 'admin', '2026-07-12 22:34:48', '', NULL, '余额购买订阅');
INSERT INTO `ai_subscription_record` VALUES (16, 1, 'admin', 1, '基础套餐A', 9, 'cancel', 0.0000000000, '后台取消', 'admin', '0', 'admin', '2026-07-12 22:35:18', '', NULL, '取消订阅');
INSERT INTO `ai_subscription_record` VALUES (17, 1, 'admin', 4, '高级套餐B', 10, 'purchase', 169.0000000000, '余额购买', 'admin', '0', 'admin', '2026-07-12 22:35:35', '', NULL, '余额购买订阅');
INSERT INTO `ai_subscription_record` VALUES (18, 1, 'admin', 4, '高级套餐B', 10, 'cancel', 0.0000000000, '后台取消', 'admin', '0', 'admin', '2026-07-12 22:38:35', '', NULL, '取消订阅');
INSERT INTO `ai_subscription_record` VALUES (19, 1, 'admin', 1, '基础套餐A', 11, 'purchase', 79.0000000000, '余额购买', 'admin', '0', 'admin', '2026-07-12 22:39:05', '', NULL, '余额购买订阅');
INSERT INTO `ai_subscription_record` VALUES (20, 106, 'a15902193', 1, '基础套餐A', 12, 'purchase', 79.0000000000, '余额购买', 'a15902193', '0', 'a15902193', '2026-07-18 19:43:16', '', NULL, '余额购买订阅');
...
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'AI用户订阅' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ai_user_subscription
-- ----------------------------
INSERT INTO `ai_user_subscription` VALUES (7, 104, 'a15902193', 1, '基础套餐A', '可用额度450刀', 79.0000000000, '2026-07-05 14:51:11', '2026-08-05 14:51:11', 'active', 89.0000000000, 0.0000390000, 0.0000000000, 'none', NULL, '2026-07-05 14:51:11', NULL, 'grant', 'admin', '2026-07-05 14:51:11', '', '2026-07-05 16:23:16', '');
INSERT INTO `ai_user_subscription` VALUES (11, 1, 'admin', 1, '基础套餐A', '可用额度450刀', 79.0000000000, '2026-07-12 22:39:06', '2026-08-12 22:39:06', 'active', 89.0000000000, 89.0000000000, 0.0000000000, 'none', NULL, '2026-07-12 22:39:06', NULL, 'balance_purchase', 'admin', '2026-07-12 22:39:05', '', '2026-07-16 23:55:14', '余额购买订阅');
INSERT INTO `ai_user_subscription` VALUES (12, 106, 'a15902193', 1, '基础套餐A', '可用额度450刀', 79.0000000000, '2026-07-18 19:43:16', '2026-08-18 19:43:16', 'active', 89.0000000000, 0.0000000000, 0.0000000000, 'none', NULL, '2026-07-18 19:43:16', NULL, 'balance_purchase', 'a15902193', '2026-07-18 19:43:16', '', NULL, '余额购买订阅');
...
INSERT INTO `sys_config` VALUES (105, '邀请返利总开关', 'ai.invite.enabled', 'true', 'Y', 'admin', '2026-06-29 00:56:49', 'admin', '2026-07-05 17:28:47', '是否开启邀请返利功能（true开启，false关闭），关闭后注册不再绑定邀请人，充值不再产生返利');
INSERT INTO `sys_config` VALUES (106, '邀请返利比例', 'ai.invite.rebateRate', '5', 'Y', 'admin', '2026-06-29 00:56:49', 'admin', '2026-07-03 00:04:01', '邀请返利全局比例（百分比，0-100），被邀请人充值时邀请人按此比例获得返利');
INSERT INTO `sys_config` VALUES (107, '邀请返利冻结期', 'ai.invite.freezeHours', '0', 'Y', 'admin', '2026-06-29 00:56:49', '', NULL, '返利冻结时长（小时，0-720），产生的返利先冻结，到期后才能领取');
INSERT INTO `sys_config` VALUES (108, '邀请返利有效期', 'ai.invite.durationDays', '0', 'Y', 'admin', '2026-06-29 00:56:49', '', NULL, '返利有效期（天，0-3650，从被邀请人注册起算，0=永久有效）');
INSERT INTO `sys_config` VALUES (109, '邀请返利单人上限', 'ai.invite.perInviteeCap', '0', 'Y', 'admin', '2026-06-29 00:56:49', '', NULL, '单个被邀请人累计返利上限（美元，0=无上限）');
...
INSERT INTO `sys_config` VALUES (114, 'AI在线充值业务开关', 'ai.pay.onlineRechargeEnabled', 'false', 'Y', 'admin', '2026-07-30 00:00:00', '', NULL, '控制用户是否可以创建新的在线充值订单；关闭后已有订单的回调、查询和补偿仍继续处理');
INSERT INTO `sys_config` VALUES (116, 'AI请求最低计费金额', 'ai.billing.minimumAmount', '0', 'Y', 'admin', '2026-08-27 00:00:00', '', NULL, '单次AI请求最终计费的最低金额（美元），仅对实际费用大于0的请求生效，0表示关闭');
INSERT INTO `sys_config` VALUES (117, '每日签到开关', 'ai.checkin.enabled', 'true', 'Y', 'admin', '2026-09-04 00:00:00', '', NULL, '是否开启每日签到（true开启，false关闭）；关闭后隐藏签到卡片并拒绝签到，未配置时默认开启');
...
INSERT INTO `sys_dict_data` VALUES (111, 2, '智谱', 'zhipu', 'ai_platform_name', '', 'success', 'N', '0', 'admin', '2026-06-27 19:53:19', '', NULL, 'AI平台：智谱');
INSERT INTO `sys_dict_data` VALUES (112, 3, 'DeepSeek', 'deepseek', 'ai_platform_name', '', 'warning', 'N', '1', 'admin', '2026-06-27 19:53:19', 'admin', '2026-06-27 20:45:53', 'AI平台：DeepSeek');
...
) ENGINE = InnoDB AUTO_INCREMENT = 1105 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统访问记录' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 3156 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '菜单权限表' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_menu` VALUES (4, '官网', 0, 5, '/index?redirect', NULL, '', '', 1, 0, 'M', '0', '0', '', 'guide', 'admin', '2026-06-01 01:27:16', 'admin', '2026-06-20 23:36:55', '若依官网地址');
...
INSERT INTO `sys_menu` VALUES (3155, '邀请参数配置', 3150, 5, '', '', '', '', 1, 0, 'F', '0', '0', 'aigate:invite:config', '#', 'admin', '2026-07-29 00:00:00', '', NULL, '邀请返利全局参数配置');
INSERT INTO `sys_menu` VALUES (3156, '结算异常', 3000, 11, 'billing-settlement', 'aigate/billing-settlement/index', '', '', 1, 0, 'C', '0', '0', 'aigate:billingSettlement:list', 'warning', 'admin', '2026-08-07 00:00:00', '', NULL, '异步结算失败任务处置中心');
...
-- ----------------------------
INSERT INTO `sys_notice` VALUES (1, '温馨提醒：2018-07-01 若依新版本发布啦', '2', 0xE696B0E78988E69CACE58685E5AEB9, '0', 'admin', '2026-06-01 01:27:16', '', NULL, '管理员');
INSERT INTO `sys_notice` VALUES (2, '维护通知：2018-07-01 若依系统凌晨维护', '1', 0xE7BBB4E68AA4E58685E5AEB9, '0', 'admin', '2026-06-01 01:27:16', '', NULL, '管理员');
...
) ENGINE = InnoDB AUTO_INCREMENT = 15 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '公告已读记录表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sys_notice_read
-- ----------------------------
INSERT INTO `sys_notice_read` VALUES (1, 3, 1, '2026-06-01 01:31:25');
INSERT INTO `sys_notice_read` VALUES (2, 2, 1, '2026-06-04 17:03:39');
INSERT INTO `sys_notice_read` VALUES (3, 1, 1, '2026-06-09 00:43:16');
INSERT INTO `sys_notice_read` VALUES (8, 3, 101, '2026-06-10 14:11:15');
INSERT INTO `sys_notice_read` VALUES (9, 2, 101, '2026-06-10 14:11:24');
INSERT INTO `sys_notice_read` VALUES (10, 1, 101, '2026-06-10 15:10:49');
INSERT INTO `sys_notice_read` VALUES (11, 3, 106, '2026-07-20 02:14:11');
INSERT INTO `sys_notice_read` VALUES (12, 2, 106, '2026-07-20 02:14:19');
INSERT INTO `sys_notice_read` VALUES (13, 1, 106, '2026-07-20 02:14:22');
...
) ENGINE = InnoDB AUTO_INCREMENT = 409 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '操作日志记录' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_role` VALUES (2, '普通角色', 'common', 2, '2', 1, 1, '0', '0', 'admin', '2026-06-01 01:27:16', 'admin', '2026-06-23 16:39:31', '普通角色');
...
INSERT INTO `sys_role_menu` VALUES (2, 3079);
INSERT INTO `sys_role_menu` VALUES (2, 3092);
INSERT INTO `sys_role_menu` VALUES (2, 3093);
...
INSERT INTO `sys_role_menu` VALUES (2, 3117);
INSERT INTO `sys_role_menu` VALUES (2, 3118);
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 103, 'admin', 'CHAI', '00', '15902193@qq.com', '13263221890', '0', '/profile/avatar/2026/06/02/0e26f462902c4a39aa44ec3ff5b834ca.jpeg', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2026-07-23 13:04:27', '2026-06-01 01:27:16', 'admin', '2026-06-01 01:27:16', '', '2026-07-23 13:25:19', '管理员', 101.6706140000, 0.0000000000, 4.2694136005, 664, 'subscription_first', 100, 0, 1.00);
...
INSERT INTO `sys_user` VALUES (106, NULL, 'a15902193', 'a15902193', '00', '13263221890@163.com', '', '0', '', '$2a$10$CsxkC1jRSdGbPuN2M35hHuhEQu1aCJS6J2in4GQ4hoNpknVLkt41G', '0', '2', '127.0.0.1', '2026-07-20 10:41:20', '2026-07-18 12:24:25', '', '2026-07-05 19:00:26', '', '2026-07-20 02:14:31', NULL, 21.7191000000, 0.0000000000, 0.0000000000, 0, 'subscription_first', 100, 0, 1.00);
INSERT INTO `sys_user` VALUES (107, 100, 'test1', 'test1', '00', '13263221890@163.com', '13263221892', '1', '', '$2a$10$aPBy2UXTxjPqTRAGPEXxfuO.VE9pj6w8gnlZbULsIXNGcwZij98Rm', '0', '0', '127.0.0.1', '2026-07-22 09:50:09', '2026-07-20 10:52:17', 'admin', '2026-07-20 10:44:13', '', '2026-07-22 10:13:56', NULL, 0.7227988000, 0.0000000000, 0.2772012000, 6, 'subscription_first', 100, 0, 1.00);
